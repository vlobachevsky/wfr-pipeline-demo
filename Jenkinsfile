...
private void updateDB() {
    ...
    bat 'java -showversion -Xms512m -Xmx1024m -Xss1m -classpath ".\\web\\WEB-INF\\classes;.\\web\\WEB-INF\\lib\\*; " RunSQL delay=0 output.result=0 output.sql=0 error.handling=EXIT output.verbose=1 uri=jdbc:sqlserver://%dbServerName%:1433;DatabaseName=%DB_NAME%;encrypt=false user=sa password=Admin1234 input.file=sql\\DBUpdateCurrentSprint.txt  jdbc.driver=com.microsoft.sqlserver.jdbc.SQLServerDriver'
